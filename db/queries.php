<?php
    return array(
        ...
        "get_current_session_value" => "SELECT IFNULL(info, 0) as json FROM cas_logs WHERE status = 'success' and command = :command and session = :session ORDER BY timestamp DESC LIMIT 1"
    );
?>